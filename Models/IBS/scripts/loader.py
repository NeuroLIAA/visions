...
def load_checkpoint(output_path, config):
    checkpoint = {}
...
def load_config(config_dir, config_name, image_size, max_scanpath_length, number_of_processes, save_probability_maps, human_scanpaths):
