...
for tr = trlist
    figure(100+tr); clf;
        ...
        subplot(3,3,[1:6])
            hold on
                im  = imread(fullfile('/home/usuario/repos/vs_models/images',smpinfo(tr).image_name));   
                [sy,sx] = size(im);
        ...
        subplot(3,3,9)
            hold on
                tar = imread(fullfile('/home/usuario/repos/vs_models/templates',smpinfo(tr).target_name));   
                [sty,stx] = size(tar);
