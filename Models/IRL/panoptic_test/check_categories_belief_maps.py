...
for trial in trials_properties:
    ...
    panoptic_seg, segments_info = run_detectron(image, (20, 32))
    ...
    if total_categories_in_detectron != total_categories_in_belief_maps:
        print('Total categories in detectron:   ' + str(total_categories_in_detectron))
...
print('Categories in belief maps not found in detectron: ' + str(extra_categories))
print('Total number of categories in belief maps not found in detectron: ' + str(number_of_extra_categories))
