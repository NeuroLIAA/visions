...
for image_file in images_files:
    ...
    belief_maps_hi_res  = torch.from_numpy(create_categories_masks(number_of_categories, output_size, hi_res_segments_info, hi_res_panoptic_seg.numpy()))
    belief_maps_low_res = torch.from_numpy(create_categories_masks(number_of_categories, output_size, low_res_segments_info, low_res_panoptic_seg.numpy()))
