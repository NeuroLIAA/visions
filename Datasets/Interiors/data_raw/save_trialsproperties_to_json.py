...
for record in range(len(targets_positions_mat[0])):
    ...
    trials_properties.append({ "image" : image_name, "target" : template_name, "dataset" : "Interiors Dataset", "target_matched_row" : matched_row, "target_matched_column" : matched_column, \
